...
//    private boolean emptySeat;
    ...
    public Ticket(UUID personId, String movieId, Integer raw, Integer seat, Integer price) {
...
//        emptySeat = true;
    ...
    public Ticket(Integer id, UUID personId, String movieId, Integer raw, Integer seat, Integer price) {
        this.id = id;
        this.personId = personId;
        this.movieId = movieId;
        this.raw = raw;
